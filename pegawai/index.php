...
<form id="form-login" name="login" method="post" action="cek_login.php" onSubmit="return validasi(this)">
  ...
  * Pegawai yang belum mempunyai user untuk login silahkan registrasi disini <a style="color:#ffcf43" href='registrasi.php'>Registrasi Pegawai</a> , selanjutnya silahkan login menggunakan NIP dan password * <a style="color:#ffcf43" href="" target="_blank"></a>
</div>
...
<!-- Footer -->
<div id="footer">Copyright &copy; 2012 by Adi Gunawan<a style="color:#ffcf43" href= target="_blank"></a></div>
